      ...
      <div className="login-card fade-in">
        <div className="login-icon">
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
            ...
            <circle cx="18" cy="16" r="3" fill="#fff" opacity="0.5" />
          </svg>
        </div>

        <h1 className="login-title">Music Dashboard</h1>
        <p className="login-subtitle">Discord 음악봇을 브라우저에서 제어하세요</p>
        ...
        <button className="login-btn" onClick={handleLogin} disabled={loading}>
          ...
          {loading ? "연결 중..." : "Discord로 시작하기"}
        </button>

        <p className="login-footer">
          <a href="https://discord.com/privacy" target="_blank" rel="noopener">개인정보처리방침</a>
        </p>
      </div>
    </div>
  );
